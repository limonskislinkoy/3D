...
sf::VertexArray line(sf::Lines, Number_v);
sf::Clock clock1;

sf::VertexArray points(sf::Points, Number_points);
...
int main()
{
    ...
    while (window.isOpen())
    {
        ...
        points[count_frames].position = line[(Number_lines-1)*2+1].position;
        points[count_frames].color = sf::Color::White;
